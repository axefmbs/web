...
class Supplier(models.Model):
	...
	supplier_documents1=models.FileField(upload_to='supplier_documents',verbose_name='证件1',blank=True)
	supplier_documents2=models.FileField(upload_to='supplier_documents',verbose_name='证件2',blank=True)
	supplier_documents3=models.FileField(upload_to='supplier_documents',verbose_name='证件3',blank=True)
